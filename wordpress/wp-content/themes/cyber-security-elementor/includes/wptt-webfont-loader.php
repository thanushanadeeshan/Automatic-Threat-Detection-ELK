...
if ( ! function_exists( 'cyber_security_elementor_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function cyber_security_elementor_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
...
if ( ! function_exists( 'cyber_security_elementor_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function cyber_security_elementor_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Cyber_Security_Elementor_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
